...
df = pd.read_csv('https://raw.githubusercontent.com/fifuuyyy/Ahmad-Zaky-Afify-Syam/main/DataAfifysyam.py')
...
mus = pd.read_csv('https://raw.githubusercontent.com/fifuuyyy/Ahmad-Zaky-Afify-Syam/main/DataAfifysyam.py')
X = df[['X1', 'X2', 'X3', 'X4', 'X5']]
y = df['Y']
fig = go.Figure(data=[go.Surface(z=mus.values)])

fig.update_layout(title='Afify Syam 3D', autosize=False,
...
url = 'https://raw.githubusercontent.com/fifuuyyy/Ahmad-Zaky-Afify-Syam/main/DataAfifysyam.py'
df = pd.read_csv(url)
